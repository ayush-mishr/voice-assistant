...
class AgentCore:
    ...
    SESSION_RAG_PROMPT = (
        ...
        "Be laser-focused on the user's question. Only provide information that is directly "
        "relevant to the specific topic asked. Do NOT volunteer extra information from "
        "different sections of the context (e.g., if asked about skills, do not include "
        "projects unless they are essential to explaining the skill).\n"
        ...
        "CRITICAL: Do NOT include any introductory greetings, self-identifications, or preambles. "
        "Eliminate all conversational fillers such as 'Sure!', 'Okay,', 'I see,', or 'I understand.' "
        "Start your response IMMEDIATELY with the factual answer. "
        "Do NOT repeat your previous answers or any part of the conversation history in your current response.\n"
        "Tone: Professional, authoritative, and direct. Respond as if speaking out loud. "
        "Avoid lists, bullet points, or markdown formatting. Keep responses short, "
        "generally two or three sentences.\n\n"
    ...
    ELIGIBILITY_PROMPT = (
        ...
        "You have access to both sources. You should answer questions based on the specific "
        "source they refer to. Only combine or compare both sources when the user "
        "specifically asks for an eligibility, fit, or comparison analysis. "
        "Here is how to handle different questions:\n\n"
        ...
        "answer from the KNOWLEDGE BASE as usual. Do NOT include information from the job "
        "description unless the user is asking for a comparison.\n"
        "CRITICAL: Skip all greetings and fillers. Start with the answer immediately.\n\n"
        ...
        "GENERAL RULES:\n"
        "- Be laser-focused on the user's question. Do not volunteer extra information from "
        "the context that wasn't specifically requested.\n"
